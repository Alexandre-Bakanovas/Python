...
"""
# Quando a variavel está em tudo maiusculo, por convenção, isso significa que a variavel NÃO deve 
# mudar, ou seja, não pode ser reatribuido um outro valor a ela.
